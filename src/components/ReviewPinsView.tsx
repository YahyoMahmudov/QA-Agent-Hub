    ...
    <div className="w-full space-y-6 pb-12">
      ...
      <div>
        <div className="flex items-center gap-2 text-xs font-code-sm text-[#908fa0] mb-1">
          ...
          <span>/</span>
          <span className="text-[#4cd7f6]">In-Browser Review Pins</span>
        </div>
      ...
      <div className="bg-[#102034] border border-[#26364a] rounded-xl p-4 sm:p-5">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#8083ff]/20 text-[#8083ff] flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <p className="font-body-md text-xs text-[#c7c4d7] mt-0.5">
                Drag the button below directly to your browser's bookmarks bar, or copy the JavaScript snippet to inject review pin overlays onto any page of <span className="text-[#4cd7f6] font-mono">saucedemo.com</span>.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-start lg:justify-end">
            ...
            <a
              ...
              draggable="true"
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#8083ff] text-[#0d0096] text-xs font-bold hover:bg-[#c0c1ff] transition-all cursor-grab active:cursor-grabbing shadow-md select-none"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#0b1c30] hover:bg-[#1b2b3f] text-[#c0c1ff] border border-[#26364a] text-xs font-code-sm transition-all"
            >
            ...
            <button
              ...
              className="p-2 rounded-lg bg-[#0b1c30] text-[#908fa0] hover:text-white border border-[#26364a]"
        ...
        {showBookmarkletCode && (
          <div className="mt-4 pt-3 border-t border-[#1b2b3f] font-mono text-xs">
            <span className="text-[#908fa0] block mb-1 text-[11px]">Bookmarklet Source Code:</span>
            <div className="p-3 rounded bg-[#031427] border border-[#1b2b3f] text-[#4cd7f6] overflow-x-auto whitespace-pre-wrap select-all">
              {bookmarkletCode}
            </div>
          </div>
        )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-[#0b1c30] border border-[#1b2b3f] rounded-xl p-5 flex flex-col">
          <div className="flex items-center justify-between pb-3 border-b border-[#1b2b3f]">
            <div className="flex items-center gap-2">
              <span className="material-symbols-outlined text-[#4cd7f6]">devices</span>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1 rounded-lg text-xs font-mono font-semibold transition-all ${
                isDropMode
                  ...
                  : 'bg-[#102034] text-[#4edea3] hover:bg-[#1b2b3f]'
              }`}
            >
          ...
          <div className="mt-4 rounded-lg overflow-hidden border border-[#26364a] bg-[#000f21] flex flex-col flex-1 shadow-2xl">
            {/* Browser Address Bar */}
            <div className="px-3 py-2 bg-[#102034] border-b border-[#26364a] flex items-center justify-between text-xs font-mono">
              ...
              <div className="flex-1 max-w-sm mx-4 px-3 py-1 rounded bg-[#031427] border border-[#26364a] text-[#4edea3] text-[11px] truncate flex items-center gap-1.5">
                <span className="material-symbols-outlined text-xs text-[#908fa0]">lock</span>
            ...
            <div
              ...
              className={`relative p-4 bg-[#031427] overflow-hidden min-h-[420px] select-none ${
                isDropMode ? 'cursor-crosshair' : 'cursor-default'
              }`}
            >
              {/* Simulated SauceDemo Top Nav inside Canvas */}
              <div className="flex items-center justify-between pb-3 mb-4 border-b border-[#1b2b3f] relative">
                <div className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-[#d3e4fe] text-lg">menu</span>
                  <span className="font-bold tracking-tight text-white font-headline-md text-sm">
                    Swag Labs
                  </span>
                </div>
                ...
                <div className="relative">
                  <span className="material-symbols-outlined text-[#d3e4fe] text-xl">
                    shopping_cart
                  </span>
                  <span className="absolute -top-1 -right-2 bg-[#ffb4ab] text-[#690005] font-mono text-[9px] font-bold px-1 rounded-full">
                    3
                  </span>
                  ...
                  <button
                    ...
                    className={`absolute -top-3 -right-6 w-6 h-6 rounded-full flex items-center justify-center font-mono text-[10px] font-bold shadow-lg transition-transform hover:scale-125 cursor-pointer ${
                      selectedPinId === '#PIN-03'
                        ? 'bg-[#8083ff] text-[#0d0096] ring-2 ring-white scale-110'
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-3 rounded-lg bg-[#0b1c30] border border-[#1b2b3f] relative group">
                  {/* Pin 01 Anchor */}
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    className={`absolute top-2 right-2 z-10 w-6 h-6 rounded-full flex items-center justify-center font-mono text-[10px] font-bold shadow-lg transition-transform hover:scale-125 cursor-pointer ${
                      selectedPinId === '#PIN-01'
                        ? 'bg-[#8083ff] text-[#0d0096] ring-2 ring-white scale-110'
                        : 'bg-[#ffb4ab] text-[#690005] animate-bounce'
                    }`}
                  ...
                  <div className="h-28 bg-[#000f21] rounded flex items-center justify-center relative overflow-hidden border border-[#93000a]/50">
                    <img
                    ...
                    />
                    <div className="absolute inset-0 bg-[#93000a]/40 flex items-center justify-center">
                      <span className="font-mono text-[10px] text-[#ffdad6] font-bold bg-[#93000a] px-1.5 py-0.5 rounded border border-[#ffb4ab]/40">
                        HTTP 404
                      </span>
                    </div>
                  </div>

                  <h4 className="font-bold text-xs text-[#d3e4fe] mt-2">Sauce Labs Backpack</h4>
                  <p className="text-[10px] text-[#908fa0] line-clamp-2 mt-0.5">
                    carry.allTheThings() with the sleek, streamlined Sly Pack.
                  </p>
                  <div className="flex items-center justify-between mt-2">
                    <span className="font-mono text-xs font-bold text-[#4edea3]">$29.99</span>
                    <span className="text-[10px] font-mono text-[#ffb4ab] bg-[#93000a]/20 px-1 rounded">
                      Remove
                    </span>
                  </div>
                </div>
                ...
                <div className="p-3 rounded-lg bg-[#0b1c30] border border-[#1b2b3f] relative group">
                  ...
                  <div className="h-28 bg-[#000f21] rounded flex items-center justify-center relative overflow-hidden border border-[#009eb9]/40">
                    <img
                  ...
                  <h4 className="font-bold text-xs text-[#d3e4fe] mt-2">Sauce Labs Bike Light</h4>
                  <p className="text-[10px] text-[#908fa0] line-clamp-2 mt-0.5">
                    A red light isn't the desired state in testing but it is with this bike light.
                  </p>
                  <div className="flex items-center justify-between mt-2">
                    <span className="font-mono text-xs font-bold text-[#4edea3]">$9.99</span>
                    <span className="text-[10px] font-mono text-[#8083ff] bg-[#102034] px-1.5 py-0.5 rounded">
                      Add to cart
                    </span>
                  </div>
                </div>
              ...
              {selectedPin && (
                <div className="mt-4 p-3 rounded-lg bg-[#0b1c30]/95 border border-[#8083ff]/60 shadow-xl flex items-start justify-between gap-3 text-xs">
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-mono font-bold text-[#8083ff]">{selectedPin.id}</span>
                      <span className="font-bold text-[#d3e4fe]">{selectedPin.title}</span>
                      <span
                    ...
                    <p className="text-[11px] text-[#c7c4d7] mt-1">{selectedPin.description}</p>
                    <code className="text-[10px] font-mono text-[#4cd7f6] block mt-1">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1 rounded bg-[#8083ff] text-[#0d0096] font-mono text-[11px] font-bold shrink-0 hover:bg-[#c0c1ff]"
                  >
                    {selectedPin.jiraKey}
                  </button>
                </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-[#0b1c30] border border-[#1b2b3f] rounded-xl p-5">
            <h2 className="font-headline-md text-base font-bold text-[#d3e4fe] pb-3 border-b border-[#1b2b3f] flex items-center gap-2">
              <span className="material-symbols-outlined text-[#8083ff]">edit_location</span>
              <span>Manual Pin Dropper / Inspector</span>
            </h2>

            <form onSubmit={handleCreatePin} className="mt-4 space-y-3 font-code-sm text-xs">
              <div>
                <label className="block text-[#908fa0] mb-1">Defect Title</label>
                <input
                  type="text"
                  value={newTitle}
                  onChange={(e) => setNewTitle(e.target.value)}
                  placeholder="e.g. Broken CTA button on inventory item"
                  className="w-full px-3 py-1.5 rounded-lg bg-[#031427] border border-[#1b2b3f] text-[#d3e4fe] focus:border-[#8083ff] focus:outline-hidden"
                />
              </div>

              <div>
                <label className="block text-[#908fa0] mb-1">Target Element / CSS Selector</label>
                <input
                  type="text"
                  value={newSelector}
                  onChange={(e) => setNewSelector(e.target.value)}
                  className="w-full px-3 py-1.5 rounded-lg bg-[#031427] border border-[#1b2b3f] text-[#4cd7f6] font-mono focus:border-[#8083ff] focus:outline-hidden"
                />
              </div>

              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[#908fa0] mb-1">Severity</label>
                  <select
                    value={newSeverity}
                    onChange={(e) => setNewSeverity(e.target.value as IssueSeverity)}
                    className="w-full px-2.5 py-1.5 rounded-lg bg-[#031427] border border-[#1b2b3f] text-[#d3e4fe] focus:border-[#8083ff] focus:outline-hidden"
                  >
                ...
                <div>
                  <label className="block text-[#908fa0] mb-1">Page Scope</label>
                  <select
                    className="w-full px-2.5 py-1.5 rounded-lg bg-[#031427] border border-[#1b2b3f] text-[#d3e4fe] focus:border-[#8083ff] focus:outline-hidden"
                  >
              ...
              <div>
                <label className="block text-[#908fa0] mb-1">Observation Notes</label>
                <textarea
                  rows={2}
                  value={newDescription}
                  onChange={(e) => setNewDescription(e.target.value)}
                  placeholder="Computed style misalignment, 404 response, or unexpected behavior..."
                  className="w-full px-3 py-1.5 rounded-lg bg-[#031427] border border-[#1b2b3f] text-[#d3e4fe] focus:border-[#8083ff] focus:outline-hidden resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full py-2 rounded-lg bg-[#8083ff] text-[#0d0096] font-bold text-xs hover:bg-[#c0c1ff] transition-all cursor-pointer shadow-md"
              >
                ...
                <div
                  ...
                  className={`p-3 rounded-lg border transition-all cursor-pointer ${
                    selectedPinId === pin.id
                      ? 'bg-[#102034] border-[#8083ff]'
                      : 'bg-[#031427] border-[#1b2b3f] hover:border-[#26364a]'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <span className="font-mono text-xs font-bold text-[#8083ff]">
                        {pin.id}
                      </span>
                      <span className="font-bold text-xs text-[#d3e4fe] truncate max-w-[160px]">
                        {pin.title}
                      </span>
                    </div>
                  ...
                  <p className="text-[11px] text-[#c7c4d7] mt-1 line-clamp-2">
                    {pin.description}
                  </p>

                  <div className="mt-2 pt-2 border-t border-[#1b2b3f]/60 flex items-center justify-between text-[10px] font-mono text-[#908fa0]">
                    <span>By: {pin.author}</span>
                    <span className="text-[#4cd7f6]">{pin.timeAgo}</span>
                  </div>
                </div>
              ))}
            </div>
